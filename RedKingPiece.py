...
def possible_red_king_piece_moves(current_x, current_y):
    """
    ...
    global red_king_piece
    red_king_piece = RedKingPiece(current_x, current_y, current_piece)
    CheckersPieces.possible_moves[red_king_piece] = []
